    ...
    extend: {
      colors: {
        ...
        merx: {
          ...
          error: '#DC3545',      // Erro
          // Button Colors
          'button-secondary': '#6C757D', // Botão Secundário
          'button-hover': {
            primary: '#007A3D',   // Hover Botão Primário
            secondary: '#5A6268', // Hover Botão Secundário
            cancel: '#C82333',    // Hover Botão Cancelar
          }
        },
